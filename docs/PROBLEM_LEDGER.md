...
**Last updated:** 2026-08-29 (OPE-666 Scout: fresh ≤2 shortlist after greedy #57 + Brooks A #58 + Brooks B #59 consumed. Prime `havel-hakimi`. #2 `menger-vertex`. Brooks hygiene: PR **#59 MERGED**, status stays `informal`.)
