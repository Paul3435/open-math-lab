...
**Last updated:** 2026-08-31 (OPE-759 Formalist: `moore-degree-girth` Level A+B namesake `moore_bound_odd_girth` zero-sorry. Scout OPE-754 leftover `stirling-second-kind` still unassigned.)
