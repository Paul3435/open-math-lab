...
**Last updated:** 2026-08-22 (OPE-334 Scout keep-fresh: post-PR#17 sync — VdW/Schur gates independently re-verified zero-sorry; Mathlib-gap claims re-confirmed vs pinned v4.10.0 snapshot; erdos-woods promoted to leading next-prime candidate)
...
|------------|--------|---------|-------------|---------|-------------------|
| `erdos-woods` | elem. number theory | OPE-12 attack; OPE-15 hygiene veto; OPE-334 dossier refresh | **`vetoed` claim** (wrong def / a=5). Literature fact k=16, a=2184 remains valid **candidate** for *correct* formalization. **Scout refresh 2026-08-22 (OPE-334): leading next-prime candidate** — STATEMENT pinned to literature definition (open interval (a, a+k), endpoints share prime factor with every interior j); minimal witness (16, 2184) independently re-verified by bounded Python check (all 15 interior j share a factor with 2184=2³·3·7·13 or 2200=2³·5²·11); feasibility 4.3 (compute-bounded, low crackpot risk); formalize-only, no novelty claim | Known (1980) | `problems/erdos-woods/`, `attacks/erdos-woods-20260730-125506/` (+ BOARD_VETO) |
