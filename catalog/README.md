...
2. **`british-flag` leftover (84) — CONSUMED Level A.** OPE-1273 Formalist. Director OPE-1272 approved Scout OPE-1263 leftover. Lean `ProofLab/BritishFlag.lean`. Catalog `formalized`. Level A: unit-square origin / vertex C / centre, not labelled British flag. Level B namesake `british_flag` / Napoleon / Simson / Viviani residual **out of v1**. Do not revive.
